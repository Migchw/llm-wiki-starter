...
Use this skill to execute a fast, token-efficient ingestion workflow for any research source (URL, PDF, video, filing, or document). Read `.kiro/steering/00-operating-manual.md` first if not already loaded.
...
3. **For YouTube / Videos:**
   ใช้ `.kiro/personas/rene.md` หรือ script ดึง transcript ดึง timestamped transcript ลง `01-Raw/video/`.

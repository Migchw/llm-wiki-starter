...
2. อ่าน [PROJECT-BLUEPRINT](PROJECT-BLUEPRINT.md) (คู่มือระบบฉบับสมบูรณ์) หรือพิมพ์ `/onboarding` ให้ AI พาทัวร์แบบถาม-ตอบ
...
5. สร้าง concept เฉพาะความรู้ที่ใช้ซ้ำได้ตามเกณฑ์ 4 Archetypes ของ Darwin ใน [Concept Checklist](04-Schema/Concept%20Checklist.md)
...
อ่าน [Home](05-Index/Home.md) เป็นจุดเริ่มต้นเสมอ.
